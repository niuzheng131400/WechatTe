...
function stdin_default() {
  return class Lazy {
    constructor({
      ...
      this.lazyLoadHandler = (0, import_util.throttle)(this.lazyLoadHandler.bind(this), this.options.throttleWait);
    ...
    initListen(el, start) {
      this.options.ListenEvents.forEach((evt) => (start ? import_util.on : import_util.off)(el, evt, this.lazyLoadHandler));
    }
    initEvent() {
      this.Event = {
        listeners: {
